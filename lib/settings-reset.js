...
import { AUTO_REFRESH_DEFAULT } from './auto-refresh.js';
...
export async function resetToFactoryDefaults() {
    ...
    const storagePayload = {
        ...
        autoRefreshIntervalSeconds: FACTORY_DEFAULT_GLOBAL_SETTINGS.autoRefreshIntervalSeconds,
        skipPowerConfirmations: FACTORY_DEFAULT_GLOBAL_SETTINGS.skipPowerConfirmations,
        groupByNode: FACTORY_DEFAULT_GLOBAL_SETTINGS.groupByNode,
        showClusterDashboard: FACTORY_DEFAULT_GLOBAL_SETTINGS.showClusterDashboard
    };
